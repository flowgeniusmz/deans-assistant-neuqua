...
def get_deans_assistant_title(varPageNumber):
    ...
    with title_container:
        ...
        with title_columns[1]:
            st.image('https://s3-us-west-2.amazonaws.com/sportshub2-uploads-prod/files/sites/2520/2020/08/19031312/NVLogo.png', caption='Neuqua Valley High School | Indian Plains District 204', width = 200 ) #use_column_width="auto") #Streamlit image for branding
        st.divider()
